...
import { Modal, FlatList, StyleSheet, Text, TextInput, TouchableOpacity, View, Platform, Alert, KeyboardAvoidingView, ScrollView } from 'react-native';
...
const DiscountScreen = () => {
  ...
  const handleCreateDiscount = async () => {
    if (!discountName || !discountPercent || !discountType) {
          ...
          <View style={styles.modalView}>
            {selectedDiscount && (
              <>
                ...
                <Text>{selectedDiscount.percent}% - {selectedDiscount.type}</Text>
